...
class UkuleleChordRenderer extends StatelessWidget {
  ...
  const UkuleleChordRenderer({super.key, required this.chord});
...
class UkuleleChordPainter extends CustomPainter {
  final List<int> positions;
  final List<int> fingerings;
  final int numStrings = 4;
